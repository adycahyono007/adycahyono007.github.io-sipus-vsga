...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2021 at 01:37 PM
...
('AG030', 'Adi Cahyono', 'Pria', 'Samarinda, Kaltim', 'Tidak Meminjam', '83742.jpeg');
...
('BK050', 'Pembalakan Liar', 'Karya Sastra', 'DiCa', 'Semoga Jawa', 'Tersedia');
...
CREATE TABLE `tbtransaksi` (
  ...
  `status` int(1) NOT NULL DEFAULT 0 COMMENT '0 dipinjam, 1 dikembalikan'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbtransaksi` (`idtransaksi`, `idanggota`, `idbuku`, `tglpinjam`, `tglkembali`, `status`) VALUES
('TR001', 'AG002', 'BK002', '2016-11-03', '0000-00-00', 0),
('TR002', 'AG003', 'BK003', '2016-11-04', '2016-11-04', 0),
('TR003', 'AG001', 'BK001', '2016-11-04', '2021-02-23', 0),
('TR004', 'AG003', 'BK003', '2016-11-04', '2016-11-04', 0),
('TR005', 'AG006', 'BK004', '2016-11-04', '2021-02-23', 0),
('TR006', 'AG003', 'BK005', '2016-11-05', '2016-11-05', 0),
('TR007', 'AG008', 'BK013', '2016-11-05', '2021-02-23', 0),
('TR031', 'AG010', 'BK003', '2017-01-22', '2021-02-23', 0);
